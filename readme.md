...
| :---------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :------------------------------ | :------------------------ | :----------------------------------- |
| **Doporučená platforma** *(MCU / PLC / iPC)*                                                          | **Programovatelné relé / kompaktní PLC** *(např. Siemens LOGO!, Eaton easyE4)*                                                                                                                                            | MCU (ESP32)                          | PLC (Siemens S7-1500)                     | iPC                               |
| **Pořizovací cena HW na 1 kus** *(nízká < 500 Kč / střední 5–30 tis. Kč / vysoká > 50 tis. Kč)*       | **Střední** *(cca 3 500 – 6 000 Kč)*                                                                                                                                                                                      | Střední  ( 1500 - 3000 Kč)                   | Vysoká (350 000kč)                     | Vysoká (50 000 - 100 000)                            |
| **Primární programovací jazyk** *(C/C++/MicroPython vs. IEC 61131-3 ST/LAD vs. Python/C#/C++ pod OS)* | **FBD / LAD** *(grafické funkční bloky nebo liniové schéma dle IEC 61131-3)*                                                                                                                                              | C/C++                     | LAD/FBD                     | C++                             |
| **Klíčový technický argument pro volbu** *(např. spotřeba, determinismus, grafický výkon)*            | Montáž přímo na DIN lištu v rozváděči, integrovaný displej pro nastavení časovačů přímo na místě, robustní reléové výstupy pro motor a semafor, napájení 24 V DC / 230 V AC bez nutnosti vývoje vlastního plošného spoje. |     Nízká spotřeba, rychlá odezva, nízká cena a mala velikost                     | vysoká spolehlivost, robustnost a možnost přímého řízení průmyslových I/O, pohonů a bezpečnostních funkcí                     | Industrial PC poskytuje dostatečný výpočetní výkon a flexibilitu pro zpracování vysokého objemu obrazových dat a současně umožňuje použití klasického vision algoritmu i AI/3D analýzy bez zásadní změny řídicí architektury.                       |
| **Hlavní riziko při volbě špatné platformy** *(proč by neuspěly ostatní dvě varianty)*                | **MCU:** Nutnost vývoje vlastní desky, nízká odolnost vůči venkovnímu rušení a obtížný servis údržbou.<br>**iPC:** Zbytečně extrémní cena (> 30 tis. Kč), dlouhý start po výpadku napájení a vysoká spotřeba.             | PLC( zbytečně drahý a rozměrný) iPC (Dobrý výkon, ale vyšší spotřeba a nevhodný na termostat)                            | MCU (	Omezenější průmyslové I/O, diagnostika a škálovatelnost)   iPC (Vyšší komplexita a zbytečný výpočetní výkon pro základní řízení)                    |MCU( Malé výpočetní a paměťové možnosti) PLC( Nehodí se na výpočet obrazu)                               |
...
| :--- | :--- | :--- | :--- |
| **Digitální vstup (DI)** | 4| 	3× plovákový hladinový spínač + 1× poruchový kontakt tepelné ochrany + 1× poruchový kontakt měniče/čerpadla | 5|
